test.seq.mondate <- function() {
  ...
  # by character
  seq.mondate(from = mondate("2000-04-30"), by = "days")  
  seq.mondate(to = mondate("2000-08-31"), by = "days")  
...
test.seqmondate <- function() {
  ...
  mondate.ymd(2014, 1:6)  
  seqmondate(from = mondate("1/1/2014"), length.out = 6)  
  mondate.ymd(2014, 1:6, 1)  
  seqmondate(from = mondate("2/28/2014"), length.out = 6)
  mondate.ymd(2014, 2:7)
  seqmondate(from = mondate("2/1/2014"), length.out = 6)
  c(mondate.ymd(2014, 2, 1), mondate.ymd(2014, 3:7, 2))
  ...
  seqmondate(to = mondate("04/30/2000"), by = 2)
  mondate.ymd(2000, c(1, 3))
  
  seqmondate(from = mondate("04/30/2014"), to = mondate("08/31/2014"), by = 2)
  mondate.ymd(2014, c(4, 6, 8))  

  # by character
  seqmondate(from = mondate("2000-04-30"), by = "days")  
  seqmondate(to = mondate("2000-08-31"), by = "days")  
  seqmondate(from = mondate("04/30/2014"), to = mondate("08/31/2014"), by = "days")  
  seqmondate(from = mondate("2000-04-30"), to = mondate("2000-08-31"), by = "weeks")  
  seqmondate(from = mondate("2000-04-30"), to = mondate("2000-08-31"), by = "months")  
  seqmondate(from = mondate("2000-04-30"), to = mondate("2000-08-31"), by = "years")  
  seqmondate(from = mondate("2000-04-30"), to = mondate("2000-08-31"), by = "quarters")  
  seqmondate(from = mondate("2000-04-30"), to = mondate("2000-08-31"), by = "3 months")  
  seqmondate(from = mondate("2000-04-30"), to = mondate("2000-08-31"), by = "4 years")  
  seqmondate(from = mondate("2000-04-30"), to = mondate("2000-08-31"), by = "2 quarters")  

  as.character(seqmondate(from = mondate("04/30/2014"), to = mondate("05/9/2014"), by = "days"))
  c("04/30/2014", "05/01/2014", "05/02/2014", "05/03/2014", "05/04/2014", "05/05/2014", "05/06/2014", "05/07/2014", "05/08/2014", "05/09/2014")  
  as.character(seqmondate(from = mondate("04/30/2014"), to = mondate("05/31/2014"), by = "weeks"))
  c("04/30/2014", "05/07/2014", "05/14/2014", "05/21/2014", "05/28/2014")
  seqmondate(from = mondate("04/30/2014"), to = mondate("08/31/2014"), by = "months")
  mondate.ymd(2014, 4:8)  
  seqmondate(from = mondate("04/30/2014"), to = mondate("08/31/2016"), by = "years")  
  mondate.ymd(2014:2016, 4)  
  seqmondate(from = mondate("04/30/2014"), to = mondate("08/31/2014"), by = "3 months")  
  mondate.ymd(2014, c(4, 7))  
  seqmondate(from = mondate("04/30/2014"), to = mondate("12/31/2014"), by = "2 quarters")  
  mondate.ymd(2014, c(4, 10))  
    

  # Date
  from <- as.Date("2014-01-01")
  seqmondate(from, by = "months", length = 7)
  to <- as.Date("2015-01-01")
  seqmondate(to = to, by = "months", length = 7)
  ...
  to <- as.POSIXlt("2015-01-01")
  seqmondate(to = to, by = "months", length = 6)
  seqmondate(from = from, to = to, by = "months")

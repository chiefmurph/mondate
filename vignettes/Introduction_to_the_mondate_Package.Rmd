...
The `mondate` package is preloaded with four formats for detecting dates

1. US format a: "%m/%d/%Y"
2. US format b: "%m-%d-%Y"
3. EU format a: "%Y-%m-%d" and
4. EU format b: "%Y/%m/%d"
...
and the `read.csv` function results in the example data.frame:
```{r}
data <- data.frame(
